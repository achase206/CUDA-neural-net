...
```
# To train on gpu, load a setup json file with network parameters. Json allows user to specify problem, either Morse or AB3 along with architecture and hyperparamters.
...
#### Figure 3. Morse Base Model Roofline
![Alt text](roofline_models/ab3_large_roofline.png)
#### Figure 4. Morse Base Model Roofline
...
|Fig 9A. Wide Model Stretch [6, 512, 512, 256, 128, 1]| Fig 9B. Wide Model Bend |
